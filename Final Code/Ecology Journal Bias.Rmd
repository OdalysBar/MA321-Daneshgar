...
barplot(E, names.arg = CS, xlab ="Continent", ylab = " # of Journals", col = "grey", main = "Expected # of Journals in each Continent based on the Sq. Mileage", border = "black")

O <- c(5,14,2,34,94,5,13)
C <- c("Africa", "Asia", "Aust", "Europe", "NA", "Oceania", "SA")
barplot(O, names.arg = C, xlab ="Continent", ylab = " # of Journals", col = "grey", main = "Observed # of Journals in each Continent based on Sqr. Mileage", border = "black")
```
